...
if (!class_exists('hub_AdminPageFramework_Registry', false)):
    abstract class hub_AdminPageFramework_Registry_Base {
    ...
    final class hub_AdminPageFramework_Registry extends hub_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['hub_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['hub_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('hub_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['hub_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('hub_AdminPageFramework_Bootstrap', false)):
    final class hub_AdminPageFramework_Bootstrap {
        static private $_bLoaded = false;
        public function __construct($sLibraryPath) {
            if (!$this->_isLoadable()) {
                return;
            }
            hub_AdminPageFramework_Registry::setUp($sLibraryPath);
            if (hub_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                return;
            }
            $this->_include();
        }
        ...
        private function _include() {
            include (hub_AdminPageFramework_Registry::$sAutoLoaderPath);
            new hub_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('hub_AdminPageFramework_MinifiedVersionHeader', 'hub_AdminPageFramework_BeautifiedVersionHeader',),), hub_AdminPageFramework_Registry::$aClassFiles);
            self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
            if (self::$_bXDebug) {
                new hub_AdminPageFramework_Utility;
                new hub_AdminPageFramework_WPUtility;
            }
        }
        static private $_bXDebug;
    }
    new hub_AdminPageFramework_Bootstrap(__FILE__);
endif;
