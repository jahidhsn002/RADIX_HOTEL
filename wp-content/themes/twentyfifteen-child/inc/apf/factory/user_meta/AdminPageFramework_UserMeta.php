...
abstract class hub_AdminPageFramework_UserMeta_Router extends hub_AdminPageFramework_Factory {
...
abstract class hub_AdminPageFramework_UserMeta_Model extends hub_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new hub_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class hub_AdminPageFramework_UserMeta_View extends hub_AdminPageFramework_UserMeta_Model {
...
abstract class hub_AdminPageFramework_UserMeta_Controller extends hub_AdminPageFramework_UserMeta_View {
...
abstract class hub_AdminPageFramework_UserMeta extends hub_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'localhost.com') {
