...
class hub_AdminPageFramework_View__PageRenderer extends hub_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render() {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="localhost.com-container">    
                <?php
    ...
    private function _getContentTop() {
        $_oScreenIcon = new hub_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new hub_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new hub_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug) {
        ...
        echo "<div class='localhost.com-content'>";
        ...
        echo "</div><!-- .localhost.com-content -->";
    }
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new hub_AdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'localhost.com-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
