...
class hub_AdminPageFramework_Property_admin_page extends hub_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'localhost.com') {
        ...
        $GLOBALS['ahub_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('ahub_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['ahub_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
