...
abstract class hub_AdminPageFramework_CustomSubmitFields extends hub_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class hub_AdminPageFramework_ExportOptions extends hub_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo hub_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
