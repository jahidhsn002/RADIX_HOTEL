...
class hub_AdminPageFramework_Model__FormSubmission__Validator_Base extends hub_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class hub_AdminPageFramework_Model__FormSubmission__Validator extends hub_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('hub_AdminPageFramework_Model__FormSubmission__Validator__Link', 'hub_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'hub_AdminPageFramework_Model__FormSubmission__Validator__Import', 'hub_AdminPageFramework_Model__FormSubmission__Validator__Export', 'hub_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'hub_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'hub_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'hub_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new hub_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
