...
class hub_AdminPageFramework_Model_Menu__RegisterMenu extends hub_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterMenu() {
        ...
        foreach ($this->oFactory->oProp->aPages as & $aSubMenuItem) {
            $_oFormatter = new hub_AdminPageFramework_Format_SubMenuItem($aSubMenuItem, $this->oFactory, $_iParsedIndex);
