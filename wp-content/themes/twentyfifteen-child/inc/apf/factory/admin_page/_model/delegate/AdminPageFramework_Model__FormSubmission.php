...
abstract class hub_AdminPageFramework_Model__FormSubmission_Base extends hub_AdminPageFramework_FrameworkUtility {
...
class hub_AdminPageFramework_Model__FormSubmission extends hub_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new hub_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new hub_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
