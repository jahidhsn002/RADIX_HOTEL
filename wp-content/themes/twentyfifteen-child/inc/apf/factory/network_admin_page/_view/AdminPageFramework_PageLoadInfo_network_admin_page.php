...
class hub_AdminPageFramework_PageLoadInfo_network_admin_page extends hub_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new hub_AdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
