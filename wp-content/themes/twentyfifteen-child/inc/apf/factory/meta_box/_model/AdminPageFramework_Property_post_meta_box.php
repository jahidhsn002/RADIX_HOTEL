...
class hub_AdminPageFramework_Property_post_meta_box extends hub_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'localhost.com', $sStructureType = 'post_meta_box') {
