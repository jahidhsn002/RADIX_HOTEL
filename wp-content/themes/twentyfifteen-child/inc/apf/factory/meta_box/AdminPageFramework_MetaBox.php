...
abstract class hub_AdminPageFramework_MetaBox_Router extends hub_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'localhost.com') {
...
abstract class hub_AdminPageFramework_MetaBox_Model extends hub_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'localhost.com') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new hub_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class hub_AdminPageFramework_MetaBox_View extends hub_AdminPageFramework_MetaBox_Model {
...
abstract class hub_AdminPageFramework_MetaBox_Controller extends hub_AdminPageFramework_MetaBox_View {
...
abstract class hub_AdminPageFramework_MetaBox extends hub_AdminPageFramework_MetaBox_Controller {
