...
abstract class hub_AdminPageFramework_Widget_Router extends hub_AdminPageFramework_Factory {
...
abstract class hub_AdminPageFramework_Widget_Model extends hub_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new hub_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class hub_AdminPageFramework_Widget_View extends hub_AdminPageFramework_Widget_Model {
...
abstract class hub_AdminPageFramework_Widget_Controller extends hub_AdminPageFramework_Widget_View {
...
abstract class hub_AdminPageFramework_Widget extends hub_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'localhost.com') {
