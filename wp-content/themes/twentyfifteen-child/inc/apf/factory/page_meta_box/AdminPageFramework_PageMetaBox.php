...
abstract class hub_AdminPageFramework_PageMetaBox_Router extends hub_AdminPageFramework_MetaBox_View {
...
abstract class hub_AdminPageFramework_PageMetaBox_Model extends hub_AdminPageFramework_PageMetaBox_Router {
...
abstract class hub_AdminPageFramework_PageMetaBox_View extends hub_AdminPageFramework_PageMetaBox_Model {
}
abstract class hub_AdminPageFramework_PageMetaBox_Controller extends hub_AdminPageFramework_PageMetaBox_View {
...
abstract class hub_AdminPageFramework_PageMetaBox extends hub_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'localhost.com') {
