...
abstract class hub_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'hub_AdminPageFramework_Form_', 'oPageLoadInfo' => 'hub_AdminPageFramework_PageLoadInfo_', 'oResource' => 'hub_AdminPageFramework_Resource_', 'oHelpPane' => 'hub_AdminPageFramework_HelpPane_', 'oLink' => 'hub_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'hub_AdminPageFramework_Debug', 'oUtil' => 'hub_AdminPageFramework_FrameworkUtility', 'oMsg' => 'hub_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(hub_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
...
abstract class hub_AdminPageFramework_Factory_Model extends hub_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class hub_AdminPageFramework_Factory_View extends hub_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new hub_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class hub_AdminPageFramework_Factory_Controller extends hub_AdminPageFramework_Factory_View {
...
abstract class hub_AdminPageFramework_Factory extends hub_AdminPageFramework_Factory_Controller {
}
