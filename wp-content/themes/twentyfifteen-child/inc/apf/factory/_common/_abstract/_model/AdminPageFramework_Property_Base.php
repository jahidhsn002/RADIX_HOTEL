...
abstract class hub_AdminPageFramework_Property_Base extends hub_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'localhost.com' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['ahub_AdminPageFramework'])) {
            $GLOBALS['ahub_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => hub_AdminPageFramework_Registry::NAME, 'sURI' => hub_AdminPageFramework_Registry::URI, 'sScriptName' => hub_AdminPageFramework_Registry::NAME, 'sLibraryName' => hub_AdminPageFramework_Registry::NAME, 'sLibraryURI' => hub_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => hub_AdminPageFramework_Registry::getVersion(), 'sDescription' => hub_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => hub_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => hub_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => hub_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => hub_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new hub_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
