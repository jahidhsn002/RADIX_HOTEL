...
class hub_AdminPageFramework_FieldType_submit extends hub_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".localhost.com-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";" : null, 'class' => 'localhost.com-input-label-container' . ' localhost.com-input-button-container' . ' localhost.com-input-container',);
    }
...
class hub_AdminPageFramework_FieldType_export extends hub_AdminPageFramework_FieldType_submit {
