...
abstract class hub_AdminPageFramework_FieldType_Base extends hub_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : hub_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function geFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new hub_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new hub_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class hub_AdminPageFramework_FieldType extends hub_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class hub_AdminPageFramework_FieldType_color extends hub_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".repeatable .colorpicker {display: inline;}.localhost.com-field-color .wp-picker-container {vertical-align: middle;}.localhost.com-field-color .ui-widget-content {border: none;background: none;color: transparent;}.localhost.com-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.localhost.com-field-color .localhost.com-repeatable-field-buttons {margin-top: 0;}.localhost.com-field-color .wp-color-result {margin: 3px;}";
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerhub_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerhub_AdminPageFrameworkCallbacks( {     
        added_repeatable_field: function( node, sFieldType, sFieldTagID, sCallType ) {
            ...
            registerhub_AdminPageFrameworkColorPickerField( nodeNewColorInput );     
...
jQuery( document ).ready( function(){
    registerhub_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
