...
class hub_AdminPageFramework_Form_View___Generate_FieldTagID extends hub_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class hub_AdminPageFramework_Form_View___Generate_FieldInputID extends hub_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
