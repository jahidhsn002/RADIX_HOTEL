...
class hub_AdminPageFramework_FieldType_textarea extends hub_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerhub_AdminPageFrameworkCallbacks( {				
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType, iSectionIndex, iFieldIndex ) {
            ...
            var _oSettings = jQuery().gethub_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  

            // Elements
            var _oField              = oCloned.closest( '.localhost.com-field' );
        ...
        stopped_sorting_fields : function( oSortedFields, sFieldType, sFieldsTagID, iCallType ) { 
            ...
            // Update the editor.
            oSortedFields.children( '.localhost.com-field' ).each( function( iIndex ) {
                ...
                var oSettings = jQuery().gethub_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.localhost.com-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storehub_AdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".localhost.com-field-textarea .localhost.com-input-label-string {vertical-align: top;margin-top: 2px;} .localhost.com-field-textarea .wp-core-ui.wp-editor-wrap {margin-bottom: 0.5em;}.localhost.com-field-textarea.localhost.com-field .localhost.com-input-label-container {vertical-align: top; float: left;clear: both;} .postbox .localhost.com-field-textarea .localhost.com-input-label-container {width: 100%;}.localhost.com-field-textarea textarea {max-width: 100%;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'localhost.com-field-textarea-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='localhost.com-input-label-container {$_sClassSelector}'>", "<label for='" . $aField['attributes']['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span class='localhost.com-input-label-string' style='min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";'>" . $_sLabel . "</span>" : '', $this->_getEditor($aField), $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='localhost.com-textarea-enabler'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
