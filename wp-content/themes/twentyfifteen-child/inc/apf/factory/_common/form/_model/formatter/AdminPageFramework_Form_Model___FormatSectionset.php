...
class hub_AdminPageFramework_Form_Model___FormatSectionset extends hub_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new hub_AdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);
