...
class hub_AdminPageFramework_Form_Model___SetFieldResources extends hub_AdminPageFramework_Form_Base {
    ...
    private function _setCommon() {
        ...
        self::$_bCalled = true;
        new hub_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->_setCommonFormInlineCSSRules();
    }
    private function _setCommonFormInlineCSSRules() {
        $_aClassNames = array('hub_AdminPageFramework_Form_View___CSS_Form', 'hub_AdminPageFramework_Form_View___CSS_Field', 'hub_AdminPageFramework_Form_View___CSS_Section', 'hub_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'hub_AdminPageFramework_Form_View___CSS_FieldError', 'hub_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['inline_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('hub_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function _setFieldResources(array $aFieldset) {
        ...
        new hub_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new hub_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
