...
class hub_AdminPageFramework_FieldType_radio extends hub_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".localhost.com-field input[type='radio'] {margin-right: 0.5em;} .localhost.com-field-radio .localhost.com-input-label-container {padding-right: 1em;} .localhost.com-field-radio .localhost.com-input-container {display: inline;} .localhost.com-field-radio .localhost.com-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.localhost.com-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
