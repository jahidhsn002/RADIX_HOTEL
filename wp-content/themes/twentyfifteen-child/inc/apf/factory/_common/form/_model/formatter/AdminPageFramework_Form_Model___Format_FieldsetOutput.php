...
class hub_AdminPageFramework_Form_Model___Format_Fieldset extends hub_AdminPageFramework_Form_Model___Format_FormField_Base {
...
class hub_AdminPageFramework_Form_Model___Format_FieldsetOutput extends hub_AdminPageFramework_Form_Model___Format_Fieldset {
    ...
    public function get() {
        ...
        $_oFieldTagIDGenerator = new hub_AdminPageFramework_Form_View___Generate_FieldTagID($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfTagID']);
        $_aFieldset['tag_id'] = $_oFieldTagIDGenerator->get();
        $_aFieldset['_tag_id_model'] = $_oFieldTagIDGenerator->getModel();
        $_oFieldNameGenerator = new hub_AdminPageFramework_Form_View___Generate_FieldName($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfName']);
        $_aFieldset['_field_name'] = $_oFieldNameGenerator->get();
        $_aFieldset['_field_name_model'] = $_oFieldNameGenerator->getModel();
        $_oFieldFlatNameGenerator = new hub_AdminPageFramework_Form_View___Generate_FlatFieldName($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfNameFlat']);
        ...
        $_oFieldAddressGenerator = new hub_AdminPageFramework_Form_View___Generate_FieldAddress($_aFieldset);
