...
class hub_AdminPageFramework_FieldType_taxonomy extends hub_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new hub_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enablehub_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enablehub_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerhub_AdminPageFrameworkCallbacks( {     
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            enablehub_AdminPageFrameworkTabbedBox( jQuery( oCloned ).find( '.tab-box-container' ) );            
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".localhost.com-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.localhost.com-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.localhost.com-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.localhost.com-field .taxonomy-checklist ul ul {margin-left: 1em;}.localhost.com-field .taxonomy-checklist-label {white-space: nowrap; }.localhost.com-field .tab-box-container.categorydiv {max-height: none;}.localhost.com-field .tab-box-tab-text {display: inline-block;}.localhost.com-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.localhost.com-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 2px;background-color: #fff;}.localhost.com-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.localhost.com-field .tab-box-tabs li a { color: #333; text-decoration: none; }.localhost.com-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.localhost.com-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.localhost.com-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.localhost.com-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.localhost.com-field .tab-box-content:target, .localhost.com-field .tab-box-content:target, .localhost.com-field .tab-box-content:target { display: block; }.localhost.com-field .tab-box-content .select_all_button_container, .localhost.com-field .tab-box-content .select_none_button_container{margin-top: 0.8em;}.localhost.com-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
