...
class hub_AdminPageFramework_Form_View___Script_MediaUploader extends hub_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    gethub_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
