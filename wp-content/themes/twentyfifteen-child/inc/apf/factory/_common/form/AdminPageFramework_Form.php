...
abstract class hub_AdminPageFramework_Form_Utility extends hub_AdminPageFramework_FrameworkUtility {
...
abstract class hub_AdminPageFramework_Form_Base extends hub_AdminPageFramework_Form_Utility {
...
class hub_AdminPageFramework_Form_Model extends hub_AdminPageFramework_Form_Base {
    ...
    public function getSortedInputs(array $aFormInputs) {
        ...
        $_oInputSorter = new hub_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
    ...
    public function dropRepeatableElements(array $aSubject) {
        $_oFilterRepeatableElements = new hub_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
    ...
    public function _replyToRegisterFormItems() {
        ...
        $_oFieldResources = new hub_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
    ...
    private function _setSiteWideFieldTypeDefinitions() {
        ...
        $_oBuiltInFieldTypeDefinitions = new hub_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
    ...
    public function getDefaultFormValues() {
        $_oDefaultValues = new hub_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
        return $_oDefaultValues->get();
    }
    protected function _formatElementDefinitions(array $aSavedData) {
        $_oSectionsetsFormatter = new hub_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
        $this->aSectionsets = $_oSectionsetsFormatter->get();
        $_oFieldsetsFormatter = new hub_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
...
class hub_AdminPageFramework_Form_View extends hub_AdminPageFramework_Form_Model {
    public function __construct() {
        parent::__construct();
        new hub_AdminPageFramework_Form_View__Resource($this);
    }
    public function get() {
        ...
        new hub_AdminPageFramework_Form_View___Script_Form;
        $_oFormTables = new hub_AdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->getFieldErrors(), $this->aCallbacks, $this->oMsg);
    ...
    private function _getNoScriptMessage() {
        ...
        return "<noscript>" . "<div class='error'>" . "<p class='localhost.com-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
    }
    public function printSubmitNotices() {
        $this->oSubmitNotice->render();
    }
}
class hub_AdminPageFramework_Form_Controller extends hub_AdminPageFramework_Form_View {
...
class hub_AdminPageFramework_Form extends hub_AdminPageFramework_Form_Controller {
    ...
    public function __construct() {
        ...
        $this->oSubmitNotice = new hub_AdminPageFramework_Form___SubmitNotice;
        $this->oFieldError = new hub_AdminPageFramework_Form___FieldError($this->aArguments['caller_id']);
        $this->oLastInputs = new hub_AdminPageFramework_Form_Model___LastInput($this->aArguments['caller_id']);
        parent::__construct();
        $this->construct();
    }
