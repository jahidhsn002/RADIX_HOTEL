...
class hub_AdminPageFramework_Form_View___DebugInfo extends hub_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='localhost.com-info'>" . $this->oMsg->get('debug_info') . ': ' . hub_AdminPageFramework_Registry::NAME . ' ' . hub_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}
