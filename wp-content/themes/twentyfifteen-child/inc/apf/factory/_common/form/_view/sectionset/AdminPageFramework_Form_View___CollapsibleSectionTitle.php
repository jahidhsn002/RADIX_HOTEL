...
class hub_AdminPageFramework_Form_View___Section_Base extends hub_AdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new hub_AdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
}
class hub_AdminPageFramework_Form_View___SectionTitle extends hub_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getToolTip() {
        ...
        $_oToolTip = new hub_AdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
    ...
    private function _getCollapseButton($aCollapsible) {
        ...
        return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='localhost.com-collapsible-button localhost.com-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='localhost.com-collapsible-button localhost.com-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
    }
    private function _getSectionTitleField(array $aFieldsetsets, $iSectionIndex, $aFieldTypeDefinitions) {
        foreach ($aFieldsetsets as $_aFieldsetset) {
            ...
            $_oFieldsetOutputFormatter = new hub_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldsetset, $iSectionIndex, $aFieldTypeDefinitions);
            return $_oFieldsetOutputFormatter->get();
        }
    }
}
class hub_AdminPageFramework_Form_View___CollapsibleSectionTitle extends hub_AdminPageFramework_Form_View___SectionTitle {
    ...
    private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
        ...
        return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('localhost.com-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'localhost.com-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'localhost.com-collapsible-sections-title', 'localhost.com-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'localhost.com-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
    }
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        self::$_bLoaded = true;
        new hub_AdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
    }
}
