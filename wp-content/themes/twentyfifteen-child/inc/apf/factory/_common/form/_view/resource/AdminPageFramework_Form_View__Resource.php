...
class hub_AdminPageFramework_Form_View__Resource extends hub_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    private function _setHooks() {
        ...
        new hub_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'wp_head');
    }
    private function _setAdminHooks() {
        ...
        new hub_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'admin_head');
    }
    ...
    public function _replyToAddStyle() {
        ...
        if ($_sCSSRules) {
            echo "<style type='text/css' id='inline-style-{$_sID}' class='localhost.com-form-style'>" . $_sCSSRules . "</style>";
        }
        $_sIECSSRules = $this->_getFormattedInlineStyles($this->oForm->getResources('inline_styles_ie'));
        if ($_sIECSSRules) {
            echo "<!--[if IE]><style type='text/css' id='inline-style-ie-{$_sID}' class='localhost.com-form-ie-style'>" . $_sIECSSRules . "</style><![endif]-->";
        }
    ...
    public function _replyToAddScript() {
        ...
        if ($_sScript) {
            $_sID = $this->sanitizeSlug(strtolower($this->oForm->aArguments['caller_id']));
            echo "<script type='text/javascript' id='inline-script-{$_sID}' class='localhost.com-form-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
        }
