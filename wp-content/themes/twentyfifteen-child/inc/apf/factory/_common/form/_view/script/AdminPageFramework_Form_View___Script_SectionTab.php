...
class hub_AdminPageFramework_Form_View___Script_SectionTab extends hub_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.localhost.com-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='localhost.com-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
