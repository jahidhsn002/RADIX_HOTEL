...
class hub_AdminPageFramework_FieldType_import extends hub_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".localhost.com-field-import input {margin-right: 0.5em;}.localhost.com-field-import label,.form-table td fieldset.localhost.com-fieldset .localhost.com-field-import label { display: inline; }";
    }
