...
class hub_AdminPageFramework_Form_View___ToolTip extends hub_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return '' . "<a href='{$_sHref}' class='localhost.com-form-tooltip'>" . $this->_getTipLinkIcon() . "<span class='localhost.com-form-tooltip-content'>" . $this->_getTipTitle() . $this->_getDescriptions() . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span class='localhost.com-form-tool-tip-title'>" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span class='localhost.com-form-tool-tip-description'>" . implode("</span><span class='localhost.com-form-tool-tip-description'>", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
}
