...
class hub_AdminPageFramework_FieldType_checkbox extends hub_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllhub_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllhub_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.localhost.com-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.localhost.com-checkbox-label {margin-top: 0.1em;}.localhost.com-field input[type='checkbox' ] {margin-right: 0.5em;} .localhost.com-field-checkbox .localhost.com-input-label-container {padding-right: 1em;}.localhost.com-field-checkbox .localhost.com-input-label-string{display: inline; }";
    }
...
class hub_AdminPageFramework_FieldType_posttype extends hub_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".localhost.com-field input[type='checkbox'] {margin-right: 0.5em;} .localhost.com-field-posttype .localhost.com-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
