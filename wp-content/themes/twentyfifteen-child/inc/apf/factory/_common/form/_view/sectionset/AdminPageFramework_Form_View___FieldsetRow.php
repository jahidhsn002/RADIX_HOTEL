...
class hub_AdminPageFramework_Form_View___FieldsetTableRow extends hub_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getFieldTitle(array $aField) {
        $_oInputTagIDGenerator = new hub_AdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
    ...
    private function _getToolTip($asTip, $sElementID) {
        $_oToolTip = new hub_AdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
...
class hub_AdminPageFramework_Form_View___FieldsetRow extends hub_AdminPageFramework_Form_View___FieldsetTableRow {
    public $aFieldset = array();
    public $aSavedData = array();
    public $aFieldErrors = array();
    public $aFieldTypeDefinitions = array();
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new hub_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
