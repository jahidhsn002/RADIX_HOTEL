...
class hub_AdminPageFramework_Form_View___Description extends hub_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'localhost.com-form-element-description';
