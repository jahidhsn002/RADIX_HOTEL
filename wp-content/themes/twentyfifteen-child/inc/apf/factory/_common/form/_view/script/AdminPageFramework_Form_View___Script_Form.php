...
class hub_AdminPageFramework_Form_View___Script_Form extends hub_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removehub_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.localhost.com-form-loading' ).remove();
        jQuery( '.localhost.com-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.localhost.com-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removehub_AdminPageFrameworkLoadingOutputs();
