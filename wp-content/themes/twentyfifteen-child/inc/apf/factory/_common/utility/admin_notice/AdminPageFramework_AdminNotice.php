...
class hub_AdminPageFramework_AdminNotice extends hub_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'localhost.com-settings-notice-message', 'localhost.com-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new hub_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
