...
class hub_AdminPageFramework_FrameworkUtility extends hub_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = hub_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return hub_AdminPageFramework_Registry::NAME;
    }
}
class hub_AdminPageFramework_ArrayHandler extends hub_AdminPageFramework_FrameworkUtility {
    public $aData = array();
