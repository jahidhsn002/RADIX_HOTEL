...
class hub_AdminPageFramework_WPUtility_URL extends hub_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(hub_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(hub_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = hub_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class hub_AdminPageFramework_WPUtility_HTML extends hub_AdminPageFramework_WPUtility_URL {
...
class hub_AdminPageFramework_WPUtility_Page extends hub_AdminPageFramework_WPUtility_HTML {
...
class hub_AdminPageFramework_WPUtility_Hook extends hub_AdminPageFramework_WPUtility_Page {
...
class hub_AdminPageFramework_WPUtility_File extends hub_AdminPageFramework_WPUtility_Hook {
...
class hub_AdminPageFramework_WPUtility_Option extends hub_AdminPageFramework_WPUtility_File {
...
class hub_AdminPageFramework_WPUtility_Meta extends hub_AdminPageFramework_WPUtility_Option {
...
class hub_AdminPageFramework_WPUtility_SiteInformation extends hub_AdminPageFramework_WPUtility_Meta {
...
class hub_AdminPageFramework_WPUtility_SystemInformation extends hub_AdminPageFramework_WPUtility_SiteInformation {
...
class hub_AdminPageFramework_WPUtility extends hub_AdminPageFramework_WPUtility_SystemInformation {
