...
class hub_AdminPageFramework_PointerToolTip extends hub_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInlineScript() {
        echo "<script type='text/javascript' class='localhost.com-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInlineScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
