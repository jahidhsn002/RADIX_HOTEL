...
abstract class hub_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('hub_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new hub_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
